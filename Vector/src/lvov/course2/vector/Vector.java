...
public class Vector {
    ...
    public double getElement(int index) {
        if (index < 0 || index >= elements.length) {
            throw new IndexOutOfBoundsException("Переданный индекс не может быть отрицательным, больше или равным " +
                    "размерности вектора. Переданный индекс = " + index + ". Допустимые границы {0, " +
                    (elements.length - 1) + "}");
        }
